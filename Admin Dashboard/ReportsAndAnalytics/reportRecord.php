...
$sql = "SELECT * FROM reports WHERE report_id = ? AND status = 'resolved'";
...
<body>
  ...
  <table class="table table-bordered">
    ...
    <tr>
      <th>Assigned To</th>
      <td><?php echo $schedule['assigned_to'] ?? 'N/A'; ?></td>
    </tr>
    <tr>
      <th>Scheduled Date</th>
      <td><?php echo $schedule['date'] ?? 'N/A'; ?></td>
    </tr>
    <tr>
      <th>Scheduled Time</th>
      <td><?php echo $schedule['time'] ?? 'N/A'; ?></td>
    </tr>
  </table>
  ...
  <div class="paragraph">
    <?php if ($schedule): ?>
    <p>
      On <strong><?php echo $schedule['date']; ?></strong> at <strong><?php echo $schedule['time']; ?></strong>, the
      issue reported under ID
      <strong><?php echo $report['report_id']; ?></strong> in the <strong><?php echo $report['category']; ?></strong>
      category was scheduled for resolution.
      The task was assigned to <strong><?php echo $schedule['assigned_to']; ?></strong>. The report, described as
      "<em><?php echo $report['description']; ?></em>", was initially reviewed and accepted by
      <strong><?php echo $approved_by; ?></strong>.
      This document serves as a formal record of the actions taken regarding the reported issue.
    </p>
    <?php else: ?>
    <p>
      The issue reported under ID <strong><?php echo $report['report_id']; ?></strong> in the
      <strong><?php echo $report['category']; ?></strong> category has not been scheduled for a fix yet.
      The report, described as "<em><?php echo $report['description']; ?></em>", was reviewed and accepted by
      <strong><?php echo $approved_by; ?></strong>.
    </p>
    <?php endif; ?>
  </div>
