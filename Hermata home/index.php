...
<body id="top">
  ...
  <header class="header" data-header style="height: fit-content;">
    <div class="container">
      <a href="#" class="logo">
        <img src="./assets/img/Flag_of_the_Oromia_Region.svg.png" width="120" height="30" alt="Ethiopian-logo ">
      </a>
      ...
      <nav class="navbar" data-navbar>
        ...
        <!-- <a href="#" class="logo">
          <img src="./assets/img/Flag_of_Ethiopia.svg" width="120" height="40" alt="Ethiopia - Home">
        ...
        <ul class="navbar-list"  style="margin-right: 100px;">
          ...
          <li class="navbar-item">
            <a href="#menu" class="navbar-link hover-underline">
              <div class="separator"></div>
              <span class="spans" id="spansss" style="font-size: 10px;">objectives</span>
            </a>
          </li>
  ...
  -->
  <?php 
  // Corrected include statement for footer
  $footerPath = __DIR__ . '/../common/footer.php';
  if (file_exists($footerPath)) {
      include $footerPath;
  } else {
      // Fallback footer content if file not found
      echo '<footer class="footer">';
      echo '<div class="container">';
      echo '<p>&copy; ' . date('Y') . ' Hermata Mentina Kebele Report Management System</p>';
      echo '</div>';
      echo '</footer>';
  }
  ?>
