...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
   ...
   // Debug output
    ...
    // Update user details
    $update_sql = "UPDATE residents SET fname = ?, mname = ?, fathersName = ?, birthdate = ?, phone = ?, email = ?, address = ?, fatherFullName = ?, fatherPhone = ?, motherFullName = ?, motherPhone = ?, emergencyName = ?, emergencyPhone = ?, photo = ? WHERE residence_id = ?";
...
<head>
  ...
  .form-group input {
    width: calc(100% - 20px);
    /* Ensure input fields don't touch the container edges */
    padding: 10px;
  ...
  <div class="container">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
      ...
      <!-- <div class="form-group">
        ...
        <input type="number" name="age" value="" disabled>
      </div> -->
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" id="fatherFullName" name="fatherFullName" value="<?php echo $user['fatherFullName']; ?>"
          required>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" id="motherFullName" name="motherFullName" value="<?php echo $user['motherFullName']; ?>"
          required>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" id="emergencyName" name="emergencyName" value="<?php echo $user['emergencyName']; ?>"
          required>
      </div>
      <div class="form-group">
        <label for="emergencyPhone">Emergency Contact Phone:</label>
        <input type="tel" id="emergencyPhone" name="emergencyPhone" value="<?php echo $user['emergencyPhone']; ?>"
          required>
      </div>
      <div class="form-group">
