          ...
          <form action="" method="POST" onsubmit="return validateForm();">
            <div class="form-group">
              ...
              <ul class="feedback-list">
                <li id="length_new" class="invalid-feedback">At least <strong>8 characters</strong> long <span
                    id="length_icon" class="error-icon">❌</span></li>
                <li id="uppercase_new" class="invalid-feedback">At least one <strong>uppercase letter</strong> <span
                    id="uppercase_icon" class="error-icon">❌</span></li>
                <li id="lowercase_new" class="invalid-feedback">At least one <strong>lowercase letter</strong> <span
                    id="lowercase_icon" class="error-icon">❌</span></li>
                <li id="number_new" class="invalid-feedback">At least one <strong>number</strong> <span id="number_icon"
                    class="error-icon">❌</span></li>
                <li id="special_new" class="invalid-feedback">At least one <strong>special character</strong> (e.g.,
                  @$!%*?&) <span id="special_icon" class="error-icon">❌</span></li>
              </ul>
