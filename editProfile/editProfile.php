...
<body>
  ...
  <div class="card">
    ...
    <div class="card__avatar"> <?php  echo '<a href="../editProfile/editProfile.php">';
        echo '<img src="data:image/jpeg;base64,' . $imageData . '" alt="Profile"
      ...
      <path d="m71 96.5v27.09a60.14 60.14 0 0 0 9-1.74l-2.54-8.93 5.54-2.92a2 2 0 0 0 .41-3.25z" fill="#356cb6"
        opacity=".3"></path>
      ...
      <path d="m62.76 36.94c4.24 8.74 10.71 10.21 16.09 10.21h5"
        style="fill:none;stroke-linecap:round;stroke:#fff;stroke-miterlimit:10;stroke-width:2;opacity:.1"></path>
    ...
    <div class="card__title"><?php echo "{$_SESSION['user_name']}";?></div>
    <div class="card__subtitle"><?php echo "{$_SESSION['role']}";?></div>
    <div class="card__text">Email: <spa class="card__text"><?php echo "{$_SESSION['user_email']}";?></span>
        <div class="card__wrapper">
          <button class="card__btn">Edit your profile</button>
